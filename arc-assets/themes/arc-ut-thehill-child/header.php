...
<head>
    ...
    <script>
        ...
        (function (e) {
            function t(t, n, r, o) {
                ...
                var i = e.document.createElement("link"), l = n || e.document.getElementsByTagName("script")[0], u = e.document.styleSheets;
            ...
            var n = function (r, o) {
                "use strict";
                if (r && 3 === r.length) {
                    var a = e.navigator, i = e.Image, l = !(!document.createElementNS || !document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect || !document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1") || e.opera && -1 === a.userAgent.indexOf("Chrome") || -1 !== a.userAgent.indexOf("Series40")), u = new i;
                    u.onerror = function () {
        ...
        (function (e, t) {
            ...
            var n = t.document, r = "grunticon:", o = function (e) {
                if (n.attachEvent ? "complete" === n.readyState : "loading" !== n.readyState)e(); else {
                    var t = !1;
                ...
                for (var c in e)if (a = c.slice(r.length), t = n.querySelectorAll(a + "[" + o + "]"), t.length)for (var i = 0; t.length > i; i++)t[i].innerHTML = e[c], t[i].style.backgroundImage = "none", t[i].removeAttribute(o);
                return t
            }, u = function (t) {
    ...
    <noscript>
        <link href="<?php echo get_template_directory_uri(); ?>/library/css/icons.fallback.css" rel="stylesheet">
    </noscript>


    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="<?php echo get_template_directory_uri(); ?>/images/interface/icon-114x114.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
          href="<?php echo get_template_directory_uri(); ?>/images/interface/icon-72x72.png">
    ...
    <div id="main" class="site-main">
            ...
            <div class="sidebar-offcanvas inactive">
                <nav role="navigation">
                    <button type="button" class="toggle close collapseMenu">
                        <span class="sr-only">Toggle navigation</span> <i
                            class="icon-fa-chevron-right"></i><br><?php _e('CLOSE', 'utthehill'); ?>
                    </button>
        ...
        <div class="main-content">
            ...
            <a class="sr-only" href="#content"
               title="<?php esc_attr_e('Skip to content', 'utthehill'); ?>"><?php _e('Skip to content', 'utthehill'); ?></a>


            <div id="primary" class="content-area">
                <header id="sitetitle" class="site-header" role="banner">
<!--                    <h2 class="department"><a href="--><?php //echo esc_url(home_url('/')); ?><!--"-->
...
<!--                            <small><a-->
<!--                                    href="--><?php //echo get_option('ut-site-info-parentunitlink') ?><!--">--><?php //echo get_option('ut-site-info-parentunit') ?><!--</a>-->
<!--                            </small>-->
<!--                        --><?php //endif ?>
<!--                    </h2>-->
                </header>
