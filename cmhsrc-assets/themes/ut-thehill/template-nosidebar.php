...
get_header(); ?>
															...
															<div class="slider-wrapper theme-light full-width">
																<figure id="mainslider" class="nivoSlider">
																	<?php while(has_sub_field('nivo_slider_gallery')):
																	  ...
																	  <a <?php if(isset($nivo_link) && $nivo_link != '') { echo "href='".$nivo_link."'"; } ?>><img src="<?php echo $fullimage[0]; ?>" alt="<?php  the_sub_field('title');?>" rel="<?php echo $thumb[0]; ?>" title="<?php echo $nivo_caption;?>" /></a>
																	<?php endwhile; ?>
																</figure>
															</div>											        	
		...
		<div id="content" class="site-content nosidebar<?php
              if (is_front_page()){  
